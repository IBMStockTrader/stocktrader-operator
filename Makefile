...
# IMAGE_TAG_BASE defines the ghrc.io namespace and part of the image name for remote images.
...
IMAGE_TAG_BASE ?= ghrc.io/ibmstocktrader/stocktrader-operator
...
IMG ?= ghrc.io/ibmstocktrader/stocktrader-operator:v$(VERSION)
